...
import org.tensorflow.demo.storeData;
...
public class MultiBoxTracker {
  ...
  private void processResults(
    ...
    noofrects.add(String.valueOf(rectsToTrack.size()));
  ...
  private void handleDetection(
    ...
    trackobj = "Tracking object " + potential.second.getTitle() + " with detection confidence " + potential.first + "at position " + potential.second.getLocation() + " ";
    objectname.add(potential.second.getTitle());
    conflevel.add(String.valueOf(potential.first));
    objlocation.add(String.valueOf(potential.second.getLocation()));
...
//    captured.add(trackedRecognition.title);
//    logger.i("Objects Captured" + String.valueOf(captured.size()));
    ...
    public ArrayList<String> getNoofrects() {
        return noofrects;
    }

    public ArrayList<String> getObjectname() {
        return objectname;
    }

    public ArrayList<String> getConflevel() {
        return conflevel;
    }

    public ArrayList<String> getObjlocation() {
        return objlocation;
    }
}
